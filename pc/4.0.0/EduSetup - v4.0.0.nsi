...
;文件版本声明
  ...
  VIAddVersionKey /LANG=2052 "ProductName" "互动课堂"
  ...
  VIAddVersionKey /LANG=2052 "FileDescription" "互动课堂"
...
BrandingText "如e教育www.groupnetwork.cn"
...
Section "主程序" SEC01
  ...
  File "..\如e小助手_Release\Aspose.Pdf.dll"
  ...
  File "..\如e小助手_Release\Interop.ShockwaveFlashObjects.dll"
  File "..\如e小助手_Release\AxInterop.ShockwaveFlashObjects.dll"
  File "..\如e小助手_Release\SQLite.Interop.dll"
  File "..\如e小助手_Release\System.Data.SQLite.dll"
  File "..\如e小助手_Release\RobotpenGateway.dll"
  File "..\如e小助手_Release\RobotUsbWrapper.dll"
  File "..\如e小助手_Release\AnswersCollection.dll"
  File "..\如e小助手_Release\CH9326DLL.dll"
  File "..\如e小助手_Release\log4net.dll"
  File "..\如e小助手_Release\ThoughtWorks.QRCode.dll"
  File "..\如e小助手_Release\myCode.jpg"
  File "..\如e小助手_Release\myLogo.jpg"
  File "..\如e小助手_Release\log4net.config"
  File "..\如e小助手_Release\music.jpg"
  File "..\如e小助手_Release\flash.png"
  File "..\如e小助手_Release\ffmpeg.exe"
  File "..\如e小助手_Release\html.zip"
  File "..\如e小助手_Release\SLABHIDDevice.dll"
  File "..\如e小助手_Release\SLABHIDtoUART.dll"
  File "..\如e小助手_Release\skinform.dll"
  File "..\如e小助手_Release\AlphaBlendTextBox.dll"
  
  CreateDirectory "$SMPROGRAMS\互动课堂"
  CreateShortCut "$SMPROGRAMS\如e小助手\互动课堂.lnk" "$INSTDIR\${ExeName}"
  CreateShortCut "$DESKTOP\互动课堂.lnk" "$INSTDIR\${ExeName}"
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\如e小助手\互动课堂.lnk"
